...
def worker():
    ...
    def get_result(the_data):
        ...
        try:
            ...
            the_moves, the_confs = CutUp.box_extraction(final, 'C:\\Users\\alexf\\Desktop\\reine\\cropped_imgs\\')
            ...
            return 'We couldn\'t detect all the boxes. Make sure you haven\'t erased any of the lines!', 'error', ''
